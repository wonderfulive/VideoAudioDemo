package cn.net.xyd.videoaudiodemo.video;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void checkIsCustomCameraSupported() {
		...
		if (isNeon == 0) {
			...
			Toast.makeText(MainActivity.this, "Custom Camera is not supported",
		...
		if (resultCode == RESULT_OK && null != data) {
			...
			if (uri != null) {
				...
				if (null != path) {
					...
					Log.e("record path", path);
					if (null != f && f.exists()) {

						/**
						 * Following TRY block will be helpful only if you want
						 * to Limit the duration of recorded video by user.
	...
	private void finishAsError() {
		Toast.makeText(this, getString(R.string.unable_to_get_file),
